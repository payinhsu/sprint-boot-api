 ...
 */
public class ResponseGameRounds implements Serializable {

   private static final long serialVersionUID = 395710737623406436L;
   ...
   public GameRoundsData[] getData() {
      return data;
   }

   public void setData(GameRoundsData[] data) {
      this.data = data;
   }
   ...
   public String toString() {
      ...
      builder.append("ResponseGameRounds [totalRows=");

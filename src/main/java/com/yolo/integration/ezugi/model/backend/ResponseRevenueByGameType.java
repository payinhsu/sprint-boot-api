 ...
 */
public class ResponseRevenueByGameType implements Serializable {

   private static final long serialVersionUID = 3644639374822097764L;
   ...
   private RevenueByGameTypeData[] data;
   ...
   public RevenueByGameTypeData[] getData() {
      return data;
   }

   public void setData(RevenueByGameTypeData[] data) {
      this.data = data;
   }
   ...
   public void setErrorCode(Integer errorCode) {
      if (errorCode.equals(EzugiError.OK.getReturnCode())) {
         this.errorCode = EzugiError.OK.getErrorCode();
         setError(EzugiError.OK.getErrorDesc());
      } else if (errorCode.equals(EzugiError.AUTH_ERROR.getReturnCode())) {
         this.errorCode = EzugiError.AUTH_ERROR.getErrorCode();
         setError(EzugiError.AUTH_ERROR.getErrorDesc());
      } else if (errorCode.equals(EzugiError.INVALID_REQ.getReturnCode())) {
   ...
   public String toString() {
      ...
      builder.append("ResponseRevenueByGameType [totalRows=");

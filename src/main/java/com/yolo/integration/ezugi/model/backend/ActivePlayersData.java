 ...
 * \$Revision\$
 */
public class ActivePlayersData implements Serializable {

   private static final long serialVersionUID = 632393957252467962L;

   @JsonProperty("OperatorID2")
   ...
   public String toString() {
      ...
      builder.append("ActivePlayersData [uID=");
      builder.append(getuID());
      builder.append(", operatorID2=");
      builder.append(getOperatorID2());

 ...
 */
public class ResponseActivePlayers implements Serializable {

   private static final long serialVersionUID = -4178492548296604015L;
   ...
   private ActivePlayersData[] data;
   ...
   public ActivePlayersData[] getData() {
      return data;
   }

   public void setData(ActivePlayersData[] data) {
      this.data = data;
   }
   ...
   public String toString() {
      ...
      builder.append("ResponseActivePlayers [totalRows=");
